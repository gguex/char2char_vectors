...
words_vs_occurrences.to_csv("results/WV_TIME_CENT_words_vs_objects.csv")
# Words vs Objects - regression
words_vs_regressions.to_csv("results/WV_TIME_REG_words_vs_objects.csv")
# Objects vs Words - centroids
occurrences_vs_words.to_csv("results/WV_TIME_CENT_objects_vs_words.csv")
# Objects vs Words - regression
regressions_vs_words.to_csv("results/WV_TIME_REG_objects_vs_words.csv")
...
form_lim_words_vs_occurrences.loc[:, part_1].to_csv("results/for_article/WV_TIME_CENT_words_vs_objects_LIMITED_1.csv",
                                                    index=False)
form_lim_words_vs_occurrences.loc[:, part_2].to_csv("results/for_article/WV_TIME_CENT_words_vs_objects_LIMITED_2.csv",
                                                    index=False)
form_lim_words_vs_occurrences.loc[:, part_3].to_csv("results/for_article/WV_TIME_CENT_words_vs_objects_LIMITED_3.csv",
                                                    index=False)
form_lim_words_vs_occurrences.loc[:, part_4].to_csv("results/for_article/WV_TIME_CENT_words_vs_objects_LIMITED_4.csv",
                                                    index=False)
form_lim_words_vs_regressions.loc[:, part_1].to_csv("results/for_article/WV_TIME_REG_words_vs_objects_LIMITED_1.csv",
                                                    index=False)
form_lim_words_vs_regressions.loc[:, part_2].to_csv("results/for_article/WV_TIME_REG_words_vs_objects_LIMITED_2.csv",
                                                    index=False)
form_lim_words_vs_regressions.loc[:, part_3].to_csv("results/for_article/WV_TIME_REG_words_vs_objects_LIMITED_3.csv",
                                                    index=False)
form_lim_words_vs_regressions.loc[:, part_4].to_csv("results/for_article/WV_TIME_REG_words_vs_objects_LIMITED_4.csv",
                                                    index=False)
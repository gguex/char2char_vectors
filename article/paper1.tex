...
\begin{table*}[!bh]
	...
	\caption{The 5 most associated words (similarity in parentheses) to objects regarding the \textbf{CA-CENT} method, for a selected set of characters and character pairs. Words appearing at least two times are in bold.}
\end{table*}
...
\begin{table*}[!bh]
	...
	\caption{The 5 most associated words (similarity in parentheses) to objects regarding the \textbf{CA-REG} method ($\lambda = 0.01$), for a selected set of characters and character pairs. Words appearing at least two times are in bold.}
\end{table*}
